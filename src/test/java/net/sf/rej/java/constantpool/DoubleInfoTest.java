...
public class DoubleInfoTest extends TestCase {
	...
	public final void testGetDoubleValue() {
		...
		Assert.assertEquals("618.8d", 618.8d, di.getDoubleValue(), 0d);
		di = new DoubleInfo(Double.NEGATIVE_INFINITY, cp);
		Assert.assertEquals("negative indinity", Double.NEGATIVE_INFINITY, di.getDoubleValue(), 0d);
		di = new DoubleInfo(Double.POSITIVE_INFINITY, cp);
		Assert.assertEquals("positive indinity", Double.POSITIVE_INFINITY, di.getDoubleValue(), 0d);
		di = new DoubleInfo(Double.NaN, cp);
		Assert.assertEquals("not a number", Double.NaN, di.getDoubleValue(), 0d);
	}
